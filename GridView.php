...
class GridView extends \kartik\grid\GridView
{
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="btn-toolbar kv-grid-toolbar float-right" role="toolbar">
                {toolbar}
            </div>
        </div>
    </div>
...
HTML;
    ...
    {
        parent::initPanel(); // TODO: Change the autogenerated stub
        $this->layout = strtr($this->layout, ['{pageSize}' => PageSize::widget()]);
    }
